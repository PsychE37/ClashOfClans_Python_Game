...
while 1:
    ...
    while 1:
        ...
        if win:
            ...
            variables.HERO = hero_dis
            if variables.LEVEL == 2:
                    cannon3 = building.Cannon(variables.ORIGIN_X+16,variables.ORIGIN_Y+29,3,3,80,1000)
                    cannon3.make()
                    variables.buildings.append(cannon3)
                    tower3 = building.Tower(variables.ORIGIN_X+47,variables.ORIGIN_Y+11,3,3,80,1000)
                    tower3.make()
                    variables.buildings.append(tower3)
            elif variables.LEVEL == 3:
                    cannon4 = building.Cannon(variables.ORIGIN_X+11,variables.ORIGIN_Y+14,3,3,80,1000)
                    cannon4.make()
                    variables.buildings.append(cannon4)
                    tower4 = building.Tower(variables.ORIGIN_X+72,variables.ORIGIN_Y+21,3,3,80,1000)
                    tower4.make()
...
sys.stdout.flush()
j = input()
fi = input("Save replay as:")
with open("replays/" + fi + ".txt", "a") as f:
    for i in rep:
        if i == None:
            print('n', file=f, sep='')
        else:
